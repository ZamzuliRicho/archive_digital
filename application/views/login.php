          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col">
                <div class="p-5">
                  <!-- <div>
                    <img src="./vendor/files/profilimg/logo-ads.png">
                  </div> -->
                  <div class="text-center">
                    <img src="./vendor/files/profilimg/logo-ads2.png">
                    <h1 class="h3 text-gray-900 mb-5">Selamat datang di<br>Archive Digital System</h1>
                  </div>
