                                            ...
                                            <?php if ($user == 'superadmin') { ?>
                                                <td>
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <?php if ($u->level == "2") { ?>
                                                            <a href="<?= base_url('admin/ubahlevel/1/' . $u->id_user) ?>" data-level="<?= $u->level ?>" class="badge badge-info d-block">Jadikan Admin</a>
                                                        <?php } else { ?>
                                                            <a href="<?= base_url('admin/ubahlevel/2/' . $u->id_user) ?>" data-level="<?= $u->level ?>" class="badge badge-info d-block">Jadikan User</a>
                                                        <?php } ?>
                                                    <?php } ?>
                                                </td>
                                            <?php } else {
