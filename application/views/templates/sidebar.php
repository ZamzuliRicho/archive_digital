<!-- Sidebar -->
<ul class="navbar-nav bg-background-primary sidebar sidebar-dark accordion" id="accordionSidebar">

    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('') ?>">
        <div class="sidebar-brand-icon">
            <!-- <img src="./vendor/files/profilimg/logo-ads.png" class="img-rounded" alt="Cinque Terre"> -->
        </div>
        <div class="h6 mx-2">Archive Digital System</div>
    </a>
    ...
    <?php if($user == 'superadmin'): ?>
        ...
        <a class="nav-link" href="<?php echo base_url('admin/indeks') ?>">
            <i class="fas fa-fw fa-clipboard-list"></i>
            <?php endif; ?>
            <span>Manajemen Indeks</span>
        </a>
    </li>
